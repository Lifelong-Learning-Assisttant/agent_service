...
class LLMSettings(BaseSettings):
    ...
    context7_api_key: SecretStr | None = Field(default=None, validation_alias="CONTEXT7_API_KEY")
    ...
    concurrency_limit: int = Field(default=5)  # Максимальное количество параллельных сессий
